...
import { getTopSellingBooks } from '../Services/BrowseService';
import '../Pages/Home.css';

const PopularScrolls = () => {
    ...
    <div className="home-container">
        ...
        {!loading && !error && (
            ...
            {books.length ? (
                ...
                <p>No scrolls found. Check back soon!</p>
            )}
            </div>
        )}
        </div>
